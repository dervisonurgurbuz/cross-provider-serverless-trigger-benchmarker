...
class Provider:
    ...
    LOGIN_CMDS = {
        ...
        'azure': 'az login',
        'google': 'gcloud init',
        # 'google':'gcloud auth activate-service-account --key-file="/home/ec2-user/trigger-bench/deep-beanbag-395510-35ed4ff9215b.json"',
        'ibm': 'ibmcloud login',
        'pulumi': 'login'
    }
  ...
  -v /home/ec2-user/.config/gcloud:/gcloud \
  -e GOOGLE_APPLICATION_CREDENTIALS=/gcloud/deep-beanbag-395510-35ed4ff9215b.json \
  google/cloud-sdk:380.0.0-alpine \
  gcloud auth activate-service-account --key-file='/gcloud/deep-beanbag-395510-35ed4ff9215b.json'"
        logging.info(cmd)
        os.system(cmd)
