...
#             "rate": 1,
#             "timeUnit": "1s",
#             "duration": "60m", # 3600 triggering per trigger type
#             "preAllocatedVUs": 1,
#             "maxVUs": 10
#         }
#     }
...
# Triggering functions in every 20 mins
options = {
    "scenarios": {
        "custom-scenario": {
            "executor": "constant-arrival-rate",
            "rate": 2, # Two iterations per time unit
            "timeUnit": "20m", # Time unit is 20 minutes
            "duration": "60m", # Total duration is 60 minutes
            "preAllocatedVUs": 1,
            "maxVUs": 10
        }
    }
